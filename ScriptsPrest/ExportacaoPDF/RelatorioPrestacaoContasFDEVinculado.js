function gerarPrestacaoContasVinculado(_result) {
    var config = {
    ...
    config.RecebidoTotal = (_result.Receita).toLocaleString("pt-BR", { minimumFractionDigits: 2 });
    config.RecebidoFDE = (_result.Receita - _result.VlOutrasEntradas).toLocaleString("pt-BR", { minimumFractionDigits: 2 });
    config.DespesaPeriodo = (_result.VlTotalNfs + _result.VlTotalOutrasSaidas).toLocaleString("pt-BR", { minimumFractionDigits: 2 }); 
    ...
    for (var i = 0; i < _result.NotasFiscais.length; i++)
    {
        Grid.push(
            [
                ...
                { text: _result.NotasFiscais[i].TiposDespesaCompleto != undefined && _result.NotasFiscais[i].TiposDespesaCompleto != '' ? _result.NotasFiscais[i].TiposDespesaCompleto.toString() : "", border: [false, false, true, false] },
                ...
                { text: _result.NotasFiscais[i].TiposDespesaConcatenados != undefined && _result.NotasFiscais[i].TiposDespesaConcatenados != '' ? _result.NotasFiscais[i].TiposDespesaConcatenados.toString() : "", border: [true, false, false, false], alignment: 'center' },
    ...
    for (var i = 0; i < _result.OutrasSaidas.length; i++)
    {
        Grid.push(
            [
                ...
                //{ text: '', border: [true, false, false, false], alignment: 'center' },
                { text: _result.OutrasSaidas[i].TiposDespesaConcatenados != undefined && _result.OutrasSaidas[i].TiposDespesaConcatenados != '' ? _result.OutrasSaidas[i].TiposDespesaConcatenados.toString() : "", border: [true, false, false, false], alignment: 'center' },
                            ...
                            [
                                {
                                    table: {
                                        ...
                                        body: [
                                            ...
                                            [{ text: 'Recebido FDE', border: [true, false, false, false] }, { text: config.RecebidoFDE, border: [false, false, true, false], bold: false, alignment: 'right' }],
                ...
                table: {
                    ...
                    body: [
                        [
                            ...
                            { text: '' },
                            { text: 'DESCRIÇÃO CONSUMO / PERMANENTE / SERVIÇO', rowSpan: 2, margin: [0, 2, 0, 0], border: [true, true, false, true], alignment: 'center', fontSize: 10, bold: true },
