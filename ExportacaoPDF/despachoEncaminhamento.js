function gerardespachoEncaminhamento(data) {
    ...
    config.nrFolhaMinuta = data[0].nrFolhaMinuta != undefined ? data[0].nrFolhaMinuta : "";
        ...
        var doc = {
           ...
           },
           {
               ...
               stack: [
                   ...
                   {
                       text: "DESPACHO DE ENCAMINHAMENTO"
                   }
               ],
           }
            ],
            ...
            content: [
                    {
                    ...
                    },
                     {
                         ...
                         stack: [
                                   {
                                       text: [
                                       { text: "A vista da  autorização do  Ordenador de  despesa para a  prorrogação da vigência do" },                                      
                                       ],
                                   }
                         ]
                     },
                         ...
                         stack: [
                                   {
                                       ...
                                       { text: " para  atendimento das necessidades das Unidades Escolares no âmbito desta Diretoria de Ensino " },
                                       { text: config.nomeUnidadeGestora },
                                       { text: " análise da Minuta de Termo de Prorrogação de Serviços Contínuos constante das fls. " },
                                       { text: config.nrFolhaMinuta },
                                       { text: " e manifestação nos termos da Resolução PGE-23/2015." },
                                       ],
                                   }
                         ]
                     },
                ...
                },
                {
                    ...
                    stack: [
                              {
                                  text: [
                                  { text: "De acordo. Encaminhe-se ao DECON/CCONT" },
                                  ],
                              }
                    ]
                },
