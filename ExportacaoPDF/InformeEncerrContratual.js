function gerarInformeEncerrContratual(data) {

    var config = {
        pageSize: "A4",
        pageOrientation: "portrait",
        // pageOrientation: 'landscape',
        title: "InformeEncerrContratual",
    };
    ...
    config.dataVigenciaIni = data[0].dataVigenciaIni != undefined ? dataAtualFormatada(data[0].dataVigenciaIni).trim() : "";
    config.dataVigenciaFim = data[0].dataVigenciaFim != undefined ? dataAtualFormatada(data[0].dataVigenciaFim).trim() : "";
    ...
    config.NrFolhaInforEnceContratual = data[0].NrFolhaInforEnceContratual != undefined ? data[0].NrFolhaInforEnceContratual : "";
    config.NrFolhaSolicitaMCRenegociacao = data[0].NrFolhaSolicitaMCRenegociacao != undefined ? data[0].NrFolhaSolicitaMCRenegociacao : "";
        ...
        var doc = {
           ...
           },
           {
               ...
               stack: [
                   ...
                   {
                       text: "INFORMAÇÃO DE ENCERRAMENTO CONTRATUAL"
                   }
               ],
           }
            ],
            ...
            content: [
                  ...
                  },
                  {
                      ...
                      stack: [
                                {
                                    text: [
                                    { text: "Tendo em vista a manifestação da Contratada às  fls. " },
                                    { text: config.NrFolhaSolicitaMCRenegociacao },
                                    { text: ", manifestando-se  contrária à" }
                                    ],
                                }
                      ]
                  },
                   {
                       ...
                       stack: [
                                 {
                                     text: [
                                     { text: " prorrogação da vigência Contrato nº " },
                                     { text: config.NrContrato },
                                     { text: ", referente à Prestação de  serviços de " },
                                     { text: config.descricaoObjeto },
                                     { text: ", informamos que o referido contrato terá sua vigência encerrada em" },
                   ...
                   },
                    {
                        ...
                        stack: [
                                  {
                                      text: [
                                      { text: "Os créditos em nome da contratada, referente aos serviços prestados no período de " },
                    ...
                    },
                     {
                         ...
                         stack: [
                                   {
                                      ...
                                      { text: " a " },
                                      { text: config.dataVigenciaFim },
                                      { text: " serão quitados de acordo com a Cláusula " },
                                      { text: config.DsClausulaContrato },
                                      { text: " dos pagamentos, do instrumento contratual." },
                                       ],
                                   }
                         ]
                     },
                      {
                          ...
                          stack: [
                                    {
                                        text: [
                                       { text: "Informamos ainda que foram tomadas as providências para nova contratação, de forma a " },
                                        ],
                                    }
                          ]
                      },
                      {
                          ...
                          stack: [
                                    {
                                        text: [
                                       { text: "garantir a prestação do serviço." },
                                        ],
                                    }
                          ]
                      },
