function DocEncaminhaParaDEAposRetornoCJ(idContrato, nrDocumento, anoProrrogacao, idProrrogacao, action) { 
    $.ajax({
        type: "POST",
        url: action,
        ...
        debugger
        GerarDocEncaminhaParaDEAposRetornoCJ(data);
...
function GerarDocEncaminhaParaDEAposRetornoCJ(data) {
    

    var config = {
        pageSize: "A4",
        pageOrientation: "portrait",
        title: "EncaminhaParaDEAposRetornoCJ",
    };
    ...
    for (var i = 0; i <= data[0].listProrrogacao.length - 1; i++) {
        if (data[0].listProrrogacao[i].prorrogacaoDocumento.IdDocumento == DOCS.Quadro_Demonstrativo_Valores_Prorrogacao_Cronograma_Desembolso.value) {
            ...
            idTipoContratada = data[0].listProrrogacao[i].contrato.unidadeContratada != undefined ? data[0].listProrrogacao[i].contrato.unidadeContratada : 0;
        }
    }
    config.anoVigenteProrrogacao = data[0].fluxoDocumento.prorrogacaoFluxoDevoucaoCJ.anoVigenteProrrogacao != undefined ? data[0].fluxoDocumento.prorrogacaoFluxoDevoucaoCJ.anoVigenteProrrogacao : "";
    config.nrFolhasParecer = data[0].fluxoDocumento.prorrogacaoFluxoDevoucaoCJ.nrFolhasParecer != undefined ? data[0].fluxoDocumento.prorrogacaoFluxoDevoucaoCJ.nrFolhasParecer : "";
    config.nrParecerCJSE = data[0].fluxoDocumento.prorrogacaoFluxoDevoucaoCJ.nrParecerCJSE != undefined ? data[0].fluxoDocumento.prorrogacaoFluxoDevoucaoCJ.nrParecerCJSE : "";
                ...
                [
                    [
...

                        {
                            ...
                            [
                                "\n\n......................................",
                                { text: "Retornam os autos a este CCONT/COFI, após emissão do ", alignment: "justify", bold: false, fontSize: 10, color: "black" },
                                { text: "r. Parecer CJ/SE nº " + config.nrParecerCJSE + "/" + config.anoVigenteProrrogacao + ", ", bold: true, color: "black" },
                                { text: "às folhas: ("+ config.nrFolhasParecer +"), que tratou de análise da proposta formulada pela ", color: "black" },
                                { text: "" + config.nomeUnidadeGestora, bold: true, color: "black" },
                                { text: " quanto ao aditamento ao ", bold: false, color: "black" },
                                { text: "Contrato nº " + config.NrContrato, bold: true, color: "black" },
                                { text: " firmado com a empresa " + config.NmCpfCgcCredor + ", para o qual se pretende com o ", bold: false, color: "black" },
                                { text: "Termo de Aditamento Contratual ", bold: true, color: "black" },
                                { text: "(minuta às fls. " + config.nrFolhasMinuta + ", no qual se objetiva a ", bold: true, color: "black" },
                                { text: "PRORROGAÇÃO ", bold: true, color: "black" },
                                { text: "da vigência do contrato ", bold: false, color: "black" },
                                { text: "por " + config.NovaIdPeriodoContrato + " " + config.TipoContrada + ", com início em " + config.NovaDataVigenciaIni + " e término em " + config.NovaDataVigenciaFim + ". \n\n", bold: true, color: "black" },
                            ]
                        },

                        {
                            ...
                            [
                                "\n\n......................................",
                                { text: "Cientes quanto ao referido Parecer, proponho a devolução dos autos à ", alignment: "justify", bold: false, fontSize: 10, color: "black" },
                                { text: "" + config.nomeUnidadeGestora + ", ", bold: true, color: "black" },
                                { text: "para conhecimento e ", color: "black" },
                                { text: "atendimento integral ", bold: true, color: "black" },
                                { text: "às recomendações ali apontadas. \n\n", bold: false, color: "black" },
                            ]
                        },
                        ...
                        { text: "_______________________________________________\n" + config.UsuarioLogadoNome + " / " + config.UsuarioLogadocargos, alignment: "center", fontSize: 10, bold: false, margin: [0, 0, 20, 0], },

                        { text: "De acordo.", alignment: "left", fontSize: 10, bold: true, margin: [20, 20, 20, 0], },
                        { text: "Encaminhe-se à " + config.nomeUnidadeGestora + ", para as pertinentes ", alignment: "left", fontSize: 10, bold: false, margin: [20, 0, 20, 0], },
