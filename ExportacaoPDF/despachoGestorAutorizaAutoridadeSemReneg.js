function gerardespachoGestorAutorizaAutoridadeSemReneg(data) {
    var config = {
        pageSize: "A4",
        pageOrientation: "portrait",
        // pageOrientation: 'landscape',
        title: "DespachoGestorAutorizaAutoridadeSemReneg",
    };
    ...
    config.descricaoObjeto = data[0].descricaoObjeto != undefined ? data[0].descricaoObjeto.trim() : "";
    ...
    config.nrFolhaPesquisa = data[0].nrFolhaPesquisa != undefined ? data[0].nrFolhaPesquisa : "";
    config.NrFolhaPesquisaPreco = data[0].NrFolhaPesquisaPreco != undefined ? data[0].NrFolhaPesquisaPreco : "";
    config.PesquisasPrecos = data[0].PesquisasPrecos != undefined ? data[0].PesquisasPrecos : "";
            ...
            header: [
             ...
             },
             {
                 ...
                 stack: [
                     ...
                     {
                         text: "DESPACHO DO GESTOR E AUTORIZAÇÃO DA AUTORIDADE"
                     }
                 ],
             }
            ],
                ...
                },
                  {
                      ...
                      stack: [

                           {
                               margin: [40, 10, 50, 0],
                               text: [
                                   { text: "Considerando a série histórica da execução do Contrato Nº " },
                                   { text: config.NrContrato },
                                   { text: ", firmado entre a Diretoria de " },
                           ...
                           },
                           {
                               margin: [20, 0, 50, 0],
                               text: [
                                 { text: "Ensino Região de " },
                                 { text: config.nomeUnidadeGestora },
                                 { text: " e a empresa " },
                                 { text: config.NmCpfCgcCredor },
                                 { text: ", decorrente do acompanhamento e análise da execução do objeto do contrato, e que demonstram que a Contratada detém capacidade técnica para a continuidade na prestação dos serviços, solicito nos termos da cláusula " + config.DsClausulaContrato + " da vigência e prorrogações, que seja autorizada a prorrogação do contrato de " + config.descricaoObjeto + ", destinado ao atendimento das necessidades das Unidades Escolares, com vistas a garantir um ambiente adequado para o desenvolvimento e aprendizagem dos alunos, escopo e missão da Secretaria da Educação." },
                               ]
                           },
                           {
                               margin: [40, 0, 50, 0],                         
                               text: [
                                   { text: "Ressalta-se que os preços praticados no contrato são compatíveis com o mercado, conforme " },
                               ]
                           },
                           {
                               margin: [20, 0, 50, 0],              
                               text: [
                                   { text: "demonstram " },
                                   { text: config.PesquisasPrecos },
                                   { text: ". às fls. " },
                                   { text: config.NrFolhaPesquisaPreco },
                                   { text: ", e tornando a prorrogação vantajosa para a Administração." },
                               ]
                           }
                      ],
                  },
                  ...
                  },
               {
                   ...
                   stack: [

                        {
                            margin: [40, 20, 50, 0],                            
                            text: [
                                { text: "Considerando as justificativas acima apresentadas pelo Gestor do Contrato, em cumprimento" },                                
                            ]
                        ...
                        },
                        {
                            margin: [20, 0, 50, 0],
                            text: [
                              { text: " ao disposto no parágrafo segundo do artigo 57 da Lei 8.666/1993, e no uso de minhas atribuições legais, AUTORIZO a adoção das providências com vistas à prorrogação do contrato nº " },                             
                              { text: config.NrContrato.trim() },
                              { text: ", nos termos da cláusula " },
                              { text: config.DsClausulaContrato },
                              { text: "da vigência e prorrogações, firmado entre esta Diretoria de Ensino Região" },
                              { text: config.nomeUnidadeGestora },
                              { text: " e a empresa " },
                              { text: config.NmCpfCgcCredor },
                              { text: ", cujo objeto é a prestação de serviços de " },
                        ...
                        },
                        {
                            margin: [40, 0, 50, 0],
                            text: [
                                { text: "Encaminhe-se preliminarmente ao Núcleo de Finanças para providências quanto à reserva de" },
                            ]
                        },
                        {
                            margin: [20, 0, 50, 0],
                            text: [
                                { text: " recursos e após ao Núcleo de Compras e Serviços para prosseguimento dos trâmites necessários ao aditamento," },
                                { text: " e posterior envio dos autos ao DECON/CCONT para manifestação, nos termos da Resolução PGE-23/2015." },
