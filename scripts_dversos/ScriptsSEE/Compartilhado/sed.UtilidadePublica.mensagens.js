    ...
    mensagemAlerta = function (data, modal) {
        ...
        if (data != null && data != undefined) {
            ...
            $(data).each(function () {
                _msg += this.Mensagem;
                _status = this.Status;
                _textoEscondido = this.MensagemEscondida;
            });
            ...
            if (_msg != null && _msg != undefined) {
                ...
                switch (_status) {
                    case "Erro":
                        textoEscondido = mensagem; //mensagem virar textoEscondido pois pode ter mais de um erro.
                        tipo = "erro";
                        titulo = "Erro";
                        mensagemAlerta.Show("Ocorreu um erro durante o processamento.", textoEscondido, tipo, titulo);
                        break;
                    case "Sucesso":
                        textoEscondido = _textoEscondido;
                        tipo = "sucesso";
                        titulo = "Sucesso";
...
function TratarCaracteresEspeciais(msg) {
    if (msg == null || msg == NaN || msg == "") {
        return null;
    }
