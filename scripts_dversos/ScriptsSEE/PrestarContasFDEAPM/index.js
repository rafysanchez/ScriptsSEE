...
var prestacaoContas = (function () {
    ...
    function _pesquisarFdeApm(idTransferido, idLancamento) {
        ...
        $.ajax({
            ...
            data: { __RequestVerificationToken: token, IdTransferidoFdeApm: idTransferido, IdLancamento: idLancamento, IdEscola: idEscola, IdPrograma: idPrograma, IdExercicio: idExercicio },
            type: 'POST',
            datatype: 'HTML',
            contentType: 'application/x-www-form-urlencoded; charset=utf-8',
            success: function (data) {
    ...
    return {
        ...
        atualizarConteudoAbasFdeApm: function (idTransferido, idLancamento, flgDescolaTrabalho) {
            ...
            _pesquisarFdeApm(idTransferido, idLancamento);
        },
    }
