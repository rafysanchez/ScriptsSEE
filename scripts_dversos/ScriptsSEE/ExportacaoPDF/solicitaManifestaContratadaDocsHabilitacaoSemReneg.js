function gerarsolicitaManifestaContratadaDocsHabilitacaoSemReneg(data) {
    debugger;
    ...
    var config = {
        ...
        title: "SolicitaManifestaContratadaDocsHabilitacaoSemReneg",
    };
    ...
    config.docGenerator = function (config) {
        var doc = {
            pageSize: "A4",
            title: "SolicitaManifestContratadaDocumentosHabilita",
            ...
            content: [
              
                     {
                         ...
                         stack: [
                                     ...
                                     },
                                     {
                                         ...
                                         { text: "PRORROGAÇÃO DE VIGÊNCIA CONTRATUAL", bold: false },
                     ...
                     },
                     {
                      ...
                      },
                      {
                          ...
                          stack: [
                                    {
                                        text: [
                                        { text: " DD.Dirigente Regional de Ensino, vem por intermédio deste, informar o término da  vigência do Contrato nº " },
                     ...
                     },
                     {
                         ...
                         stack: [
                                   {
                                       text: [
                                       { text: " contar do recebimento deste, se há interesse na prorrogação da vigência do contrato supracitado por mais um período de " },
                                       { text: config.IdPeriodoContrato },
                                       { text: " (" },
                                       { text: config.periodoPorExtenso },
                                       { text: ") " },
                                       { text: config.DsUnidadeContratada },
                                       { text: ", bem como encaminhe toda a documentação comprobatória das condições de habilitação, conforme item IV-Da Habilitação, do Edital " },
                                       { text: "do Pregão Eletrônico." },                                                                          
                                       ],
                                   }
                         ]
                     },
