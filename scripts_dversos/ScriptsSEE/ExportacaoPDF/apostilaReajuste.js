function obterApostilaReajuste(IdContrato, nFolhasDemonstrativoReajuste) {
    debugger;
    if (IdContrato != 0 && nFolhasDemonstrativoReajuste != "" && nFolhasDemonstrativoReajuste != 0) {
        ...
        $.ajax({
            ...
            //url: action, 
            url: '/Contratos/Reajuste/GerarApostilaReajuste',
            data: JSON.stringify({ "IdContrato": IdContrato }),
            type: 'POST',
            success: function (data) {
                debugger;
                gerarApostilaReajuste(data, nFolhasDemonstrativoReajuste);
...
function gerarApostilaReajuste(data, nFolhasDemonstrativoReajuste) {
    debugger;
    var config = {
        pageSize: "A4",
        pageOrientation: "portrait",
        // pageOrientation: 'landscape',
        title: "Apostila de Reajuste",
    };
    ...
    config.descricaoMunicipio = data[0].unidadeGestora.descricaoMunicipio != undefined ? titleize(data[0].unidadeGestora.descricaoMunicipio.toLowerCase()) : "São Paulo";
    ...
    config.nFolhasDemonstrativoReajuste = nFolhasDemonstrativoReajuste != undefined ? nFolhasDemonstrativoReajuste : "";
    //config.DsFolhaCadTerc = window.nFolhasDemonstrativoReajuste != undefined ? window.nFolhasDemonstrativoReajuste : "";
           ...
           },
           {
               ...
               stack: [

                   {
                       ...
                       text: [
                                  { text: "APOSTILA DE REAJUSTE BASE : " },
                                  { text: config.DtReajustemes },
                                  { text:"/" },
                                  { text: config.DtReajusteano },
                                  { text:" (" },
                 ...
                 },
                  {
                      ...
                      text:
                       [
                          ...
                          { text: config.NmUnidGest, bold: false },
                          { text: " - ", bold: false },
            ...
            content: [                              
                       {
                           ...
                           stack: [
                                     {
                                         text: [
                                         { text: "À vista dos elementos instrutórios deste processo, e em face da manifestação e Planilha de " },                                        
                                         ],
                                     }
                           ]
                       },
                        {
                            ...
                            stack: [
                                      {
                                          text: [
                                          { text: "Demonstrativo de Reajuste apresentada pelo gestor do contrato às fls:  " },  
                                          { text: config.nFolhasDemonstrativoReajuste },
                                          { text: ", que Aprovo, bem como o índice de "},  
                                          { text: config.NrPercentual },
                                          { text: " para cálculo de reajuste do contrato de Prestação de Serviços de : "},  
                                          { text: config.dsAssunto },
                                          { text: " base "},  
                                          { text: config.dataReferenciaReajustemes },
                                          { text: "/"},  
                                          { text: config.dataReferenciaReajusteano },
                                          { text: ", divulgado no simulador do CADTERC as fls. "}, 
                                          { text: config.DsFolhaCadTerc },
                                          { text: " do Contrato supracitado, firmado com a empresa, "},
                                          { text: config.NmCpfCgcCredor },
                                          { text: ", Autorizo o reajuste de preços, passando a base "},
                         ...
                         },
                        {
                            ...
                            stack: [
                                ...
                                { text: "Autoridade Competente – Ordenador de despesa" },
                            ],
