...
function gerardeclaracaoAutoridadeCompetente(data) {
    ...
    var config = {
        ...
        title: "DeclaracaoAutoridadeCompetente",
    };
        ...
        var doc = {
           ...
           },
           {
               ...
               stack: [
                   ...
                   {
                       text: "DECLARAÇÃO DA AUTORIDADE COMPETENTE"
                   },
                   {text:"(Artigo 2º, § 1º, da Resolução PGE nº 23/2015)"},
               ],
           }
            ],
               ...
               },
               {
                   ...
                   stack: [
                             {
                                 ...
                                 { text: config.nomeUnidadeGestora },
                                 { text: "," },
                                 { text: " em consonância com o estabelecido no artigo 2º, § 1º, da Resolução PGE nº 23/2015, declaro para todos os fins de direito que : " },
                                 ],
                             }
                   ]
               },
                {
                    ...
                    stack: [
                              ...
                              {
                                  text: [
                                  { text: "b) a prorrogação está prevista no edital e/ou contrato e respeita o limite estabelecido no artigo 57, inciso II da Lei federal nº 8.666/93 ;" },
                              ...
                              {
                                  text: [
                                  { text: "c) a medida é vantajosa economicamente para a Administração ;" },
                              ...
                              {
                                  text: [
                                  { text: "d) o serviço está sendo prestado a contento ;" },
                              ...
                              {
                                  text: [
                                  { text: "e) a contratada mantém todas as condições de habilitação e qualificação exigidas na licitação e/ou previamente à celebração do ajuste ;" },
                              ...
                              {
                                  text: [
                                  { text: "f) será providenciada a reserva orçamentária dos valores referentes ao exercício corrente ;" },
                              ...
                              {
                                  text: [
                                  { text: "g) será utilizada a minuta padrão que constitui anexo I da Resolução PGE nº 23/2015 ;" },
                              ...
                              {
                                  text: [
                                  { text: "h) serão cumpridos todos os requisitos formais estabelecidos na Resolução PGE nº 23/2015 ;" },
