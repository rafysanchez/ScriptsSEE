...
var controle = {
    ...
    BuscarLink: function (_passo) {
        ...
        var src = '/Content/VotacaoOnline/PintandoDinossauros/' + img;
        return "<img class='img-responsive' src='" + src + ".jpg'>";
    },
        ...
        $("#DivDialogPermanente").dialog({
            ...
            buttons: {
                ...
                "Vote Aqui": function () {
                    ...
                    $.ajax({
                        url: "/VotacaoOnline/VotarPintandoDinossauros2017" + sufixo,
                        type: 'POST',
                        data: {
    ...
    Confirmar: function (idOrdem) {
        ...
        $.ajax({
            //cache: false,
            url: "/VotacaoOnline/ConfirmarPintandoDinossauros2017" + sufixo,
            method: "POST",
            dataType: "html",
                ...
                if (retorno == "sucesso") {
                    Mensagem.Alert({
                        ...
                        botoes: [{
                            botao: "Sair",
                            callback: function () {
                                document.location.href = "/VotacaoOnline/" + linkRetorno;
                            }
                        }]
                    });
                }
