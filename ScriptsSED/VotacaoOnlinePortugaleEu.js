        ...
        $("#DivDialogPermanente").dialog({
            ...
            buttons: {
                ...
                "Vote Aqui": function () {
                    ...
                    $.ajax({
                        url: "/VotacaoOnline/VotarPortugaleEu" + sufixo,
                        type: 'POST',
                        data: {
    ...
    Confirmar: function (data) {
        ...
        if (data != undefined) {
            if (data == true) {
                ...
                $.ajax({
                    //cache: false,
                    url: "/VotacaoOnline/ConfirmarPortugaleEu" + sufixo,
                    method: "POST",
                    dataType: "html",
                        ...
                        if (retorno == "sucesso") {
                            Mensagem.Alert({
                                ...
                                botoes: [{
                                    botao: "Sair",
                                    callback: function () {
                                        document.location.href = sufixo.length == 0 ? "/VotacaoOnline/PortugaleEu" : "Inicio/Index";
                                    }
                                }]
                            });
                        }
