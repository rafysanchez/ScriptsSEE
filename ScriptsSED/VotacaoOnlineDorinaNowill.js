...
var controle = {
        ...
        $("#DivDialogPermanente").dialog({
            ...
            buttons: {
                ...
                "Vote Aqui": function () {
                    ...
                    $.ajax({
                        url: "/VotacaoOnline/VotarDorinaNowill" + sufixo,
                        type: 'POST',
                        data: {
    ...
    Confirmar: function (idOrdem) {
        ...
        $.ajax({
            //cache: false,
            url: "/VotacaoOnline/ConfirmarDorinaNowill" + sufixo,
            method: "POST",
            dataType: "html",
                ...
                if (retorno == "sucesso") {
                    Mensagem.Alert({
                        ...
                        botoes: [{
                            botao: "Sair",
                            callback: function () {
                                document.location.href = sufixo.length == 0 ? "/VotacaoOnline/DorinaNowill" : "Inicio/Index";
                            }
                        }]
                    });
                }
