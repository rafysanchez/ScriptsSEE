...
var CadastrarEvento = function () {
    $('#btnCadastrar').click(function () {
        $.ajax({
            cache: false,
            url: '/EventoSEE/CadastrarEventoSEE',
            type: 'POST',
            datatype: 'HTML',
            traditional: true,
            success: function (data, textStatus, jqXHR) {
...
var ConfigurarDatepicker = function () {
    $('.data').datepicker("option", "minDate", new Date(parseInt($('#AnoLetivoAtual').html()), 0, 1));
    $('.data').datepicker("option", "maxDate", new Date(parseInt($('#AnoLetivoAtual').html()), 11, 31));
};
