        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    mensagemAlert("Occoreu um erro durante o processamento!", jqXHR.responseJSON.Title, jqXHR.responseJSON.TipoException, jqXHR.responseJSON.Message);
                }
            });
            return;
        }
...
function detalharEventual(anoExercicio, cpf) {
    $.ajax({
        url: "/Eventual/DetalharEventual",
        type: "POST",
        data: {
