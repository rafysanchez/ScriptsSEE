$(document).ready(function () {
    ...
    $("#formPesquisar").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "/Eventual/ListarParametrizacoesVagas",
                type: "POST",
                data: filtros,
...
function adcionarParametrizacao() {
    $.ajax({
        url: "/Eventual/CadastrarParametrizacaoVagas",
        success: function (data, textStatus, xhr) {
...
function editarParametro(codigo) {
    $.ajax({
        url: "/Eventual/EditarParametrizacaoVagas",
        data: {
        ...
        botoes: [
            {
                ...
                callback: function () {
                    $.ajax({
                        url: "/Eventual/ExcluirParametrizacaoVagas",
                        type: "POST",
                        dataType: "json",
                        data: {
                            codigo: parseInt(codigo)
