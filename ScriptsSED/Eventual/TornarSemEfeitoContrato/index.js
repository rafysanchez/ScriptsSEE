$(document).ready(function () {
    ...
    $("#formPesquisar").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "/Eventual/PesquisarTornarSemEfeitoContrato",
                type: "GET",
                data: filtros,
...
function tornarSemEfeito(codigoEventual) {
    $.ajax({
        url: "/Eventual/TornarSemEfeitoContratoEventual",
        type: "GET",
        data: {
            codigoEventual: parseInt(codigoEventual)
        },
        success: function (data, textStatus, xhr) {
            $("<div id='modalCadastrar'>" + data + "</div>").dialog({
                title: "Tornar sem efeito contrato",
                destroy: true
            });
        },
        error: function (jqXHR, textStatus, errorThrown) {
...
function visualizar(codigoEventual) {
    $.ajax({
        url: "/Eventual/VisualizarTornarSemEfeitoContratoEventual",
        type: "POST",
        data: {
            codigoEventual: parseInt(codigoEventual)
        },
