...
var _pesquisaPrevia = (function () {
    ...
    function _obterFornecedor(cnpj) {
        ...
        $.ajax({
            cache: false,
            url: newURL + 'prestacaocontas/PesquisaPreviaFDEAPM/ObterFornecedor',
            data: { cnpj: cnpj },
            type: 'POST',
            datatype: 'JSON',
            contentType: 'application/x-www-form-urlencoded; charset=utf-8',
    ...
    function _atualizarGrid() {
        ...
        var tr = String.format("<tr data-id='{8}'>"+                
                       ...
                       "<td>{6}</td>"+
                       "<td>{7}</td>"+
                       "<td>  <a id='btnEditarPesquisaPrevia' data-id='{8}' class='fa fa-pencil-square-o' style='font-size:15px; cursor:pointer;'>  </a></td>"+
                       "<td> <a id='btnExcluirPesquisaPrevia' data-id='{8}' class='fa fa-trash-o' style='font-size:15px; cursor:pointer;'> </a></td>"+
